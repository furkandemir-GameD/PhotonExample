...
public class MetaballCellCluster : MetaballCellClusterInterface {
    ...
    public MetaballCell AddCell(Vector3 position, float minDistanceCoef = 1.0f, float ? radius = null, Color ? baseColor = null, string tag = null)
    {
        MetaballCell cell = new MetaballCell();

        cell.baseColor = ( baseColor == null )? _baseColor : new Vector3(baseColor.Value.r, baseColor.Value.g, baseColor.Value.b);
